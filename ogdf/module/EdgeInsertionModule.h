 ...
 * last checkin:
 *   $Author: gutwenger $ 
 *   $Date: 2007-11-13 12:32:13 +0100 (Di, 13 Nov 2007) $ 
 ***************************************************************/
 ...
 *
 * \bug Call with PlanRep and GraphAttributes does not work (always crashes); call
 * with PlanRepUML is ok.
 */
class EdgeInsertionModule : public Module, public Timeouter {
public:
