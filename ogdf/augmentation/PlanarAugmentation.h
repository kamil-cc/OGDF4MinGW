 ...
 */
class PlanarAugmentation : public AugmentationModule {
...
private:
	 ...
	 * dependancies beteween bc-nodes. The adjacencies in the bc-tree won't be updated.
	 */
...
private:
	...
	/**
	 * \brief ;akes the graph connected by new edges between pendants of
