...
#define OGDF_COINY_H
	...
	#define THROW_NO_COIN_EXCEPTION THROW_PARAM(LibraryNotSupportedException, lnscCoin)
	...
	#define THROW_NO_CALLBACK_EXCEPTION 
...
//			enum BranchReturn { BR_Error, ... };
			virtual CutReturn cutCallback(const double objValue, const double* fracSolution, OsiCuts* addThese) { THROW_NO_CALLBACK_EXCEPTION; return CR_Error; };
			virtual HeuristicReturn heuristicCallback(double& objValue, double* solution) { THROW_NO_CALLBACK_EXCEPTION; return HR_Error; };
			virtual IncumbentReturn incumbentCallback(const double objValue, const double* solution) { THROW_NO_CALLBACK_EXCEPTION; return IR_Error; };
//			virtual BranchReturn branchCallback() { THROW_NO_CALLBACK_EXCEPTION; return BR_Error; };
		private:
