...
#ifndef OGDF_ExtractKuratowskis_H
#define OGDF_ExtractKuratowskis_H
...
class ExtractKuratowskis {
	public:
		...
		#ifdef STATISTICS
		void statisticsOutput(const SListPure<KuratowskiStructure>& allKuratowskis);
		#endif
	...
	protected:
		...
		// ONLY FILE_OUTPUT: GraphAttributes
	  	#ifdef FILE_OUTPUT
		...
		#ifdef OGDF_DEBUG
		//! Iff not in statistics mode, delete all statistics
		std::ostream& nirvana;
		#endif
