 ...
 */
class DynamicSPQRTree : public virtual SPQRTree, public DynamicSPQRForest
{
public:
	...
	{
		switch (m_tNode_type[findSPQR(v)]) {
			case DynamicSPQRForest::SComp: return SPQRTree::SNode;
			case DynamicSPQRForest::PComp: return SPQRTree::PNode;
			case DynamicSPQRForest::RComp: return SPQRTree::RNode;
			default:
				OGDF_ASSERT(false);
				return SPQRTree::SNode; // avoid compiler warning
		}
	}
