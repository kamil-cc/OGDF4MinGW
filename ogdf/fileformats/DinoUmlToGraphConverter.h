...
namespace ogdf {
	...
	private:
		 ...
		 *  reported in #m_logFile.
		 *  @param diagramGraphs The list of diagram graphs which have to be created for
		 *  each diagram contained in the uml model.
		 *  @return Returns true if conversion was succesful, false otherwise.
		 *  \todo Currently only class diagrams are handled. Must be extended to handle
		 *  other kinds of uml diagrams.
		 */
		bool createDiagramGraphs(SList<DinoUmlDiagramGraph*> &diagramGraphs);
