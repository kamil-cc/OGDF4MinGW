...
public:
	...
	PQNode<edge,indInfo*,bool>*
		scanSibLeft(PQNode<edge,indInfo*,bool> *nodePtr) const
		{ return clientSibLeft(nodePtr);} 

	PQNode<edge,indInfo*,bool>*
		scanSibRight(PQNode<edge,indInfo*,bool> *nodePtr) const 
		{ return clientSibRight(nodePtr);} 

	PQNode<edge,indInfo*,bool>*
		scanLeftEndmost(PQNode<edge,indInfo*,bool> *nodePtr) const
		{ return clientLeftEndmost(nodePtr);} 

	PQNode<edge,indInfo*,bool>*
		scanRightEndmost(PQNode<edge,indInfo*,bool> *nodePtr) const
		{ return clientRightEndmost(nodePtr);} 

	PQNode<edge,indInfo*,bool>*
		scanNextSib(PQNode<edge,indInfo*,bool> *nodePtr, 
