 ...
 * last checkin:
 *   $Author: klein $ 
 *   $Date: 2007-11-15 10:18:45 +0100 (Do, 15 Nov 2007) $ 
 ***************************************************************/
...
#ifndef OGDF_INTERSECTION_RECTANGLE
#define OGDF_INTERSECTION_RECTANGLE
...
//sorted sequences
class PointComparer : public Comparer<DPoint> {
public:
	PointComparer() {};
	int compare(const DPoint &p1, const DPoint &p2) {
