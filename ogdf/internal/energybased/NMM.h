...
class NMM 
{
   ...
   private:
      ...
      void split_in_x_direction(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
				List<ParticleInfo>& L_y_copy,List<ParticleInfo>*& 
				L_x_left_ptr,List <ParticleInfo>*& L_y_left_ptr,List
				<ParticleInfo>*& L_x_right_ptr,List <ParticleInfo>*& 
				L_y_right_ptr);
      
      //The Lists *act_ptr->get_x(y)_List_ptr() are split into two subLists containing
      //the particles in the top /bottom half ...
      void split_in_y_direction(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
				List<ParticleInfo>&L_y_copy,List<ParticleInfo>*& 
				L_x_bottom_ptr,List <ParticleInfo>*& L_y_bottom_ptr,List
				<ParticleInfo>*& L_x_top_ptr,List <ParticleInfo>*& 
				L_y_top_ptr);
      ...
      void x_delete_right_subLists(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
				   List<ParticleInfo>&L_y_copy,List<ParticleInfo>*& 
				   L_x_left_ptr,List <ParticleInfo>*& L_y_left_ptr,List
				   <ParticleInfo>*& L_x_right_ptr,List <ParticleInfo>*& 
				   L_y_right_ptr,ListIterator<ParticleInfo> 
				   last_left_item);
      
      //Analogue as above.
      void x_delete_left_subLists(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
				  List<ParticleInfo>&L_y_copy,List<ParticleInfo>*& 
				  L_x_left_ptr,List <ParticleInfo>*& L_y_left_ptr,List
				  <ParticleInfo>*& L_x_right_ptr,List <ParticleInfo>*& 
				  L_y_right_ptr,ListIterator<ParticleInfo> 
      ...
      //the ... 
      void y_delete_right_subLists(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
				   List<ParticleInfo>&L_y_copy,List<ParticleInfo>*& 
				   L_x_left_ptr,List <ParticleInfo>*& L_y_left_ptr,List
				   <ParticleInfo>*& L_x_right_ptr,List <ParticleInfo>*& 
				   L_y_right_ptr,ListIterator<ParticleInfo> 
      ...
      //Analogue as above.
      void y_delete_left_subLists(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
				  List<ParticleInfo>&L_y_copy,List<ParticleInfo>*& 
				  L_x_left_ptr,List <ParticleInfo>*& L_y_left_ptr,List
				  <ParticleInfo>*& L_x_right_ptr,List <ParticleInfo>*& 
				  L_y_right_ptr,ListIterator<ParticleInfo> 
      ...
      void split_in_y_direction(QuadTreeNodeNM* act_ptr,List<ParticleInfo>*& L_x_ptr,
				List <ParticleInfo>*& L_x_b_ptr,List<ParticleInfo>*& 
				L_x_t_ptr,List<ParticleInfo>*& L_y_ptr,List 
				<ParticleInfo>*& L_y_b_ptr,List<ParticleInfo>*& 
				L_y_t_ptr);
      ...
      void set_contained_nodes_for_leaves(NodeArray<NodeAttributes>& A,QuadTreeNM& T,
      ...
      void calculate_neighbourcell_forces(const Graph& G, NodeArray<NodeAttributes>& 
