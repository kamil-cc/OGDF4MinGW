...
public:
	 ...
	 *        If \a str is shorter than \a maxLen or \a maxLen is -1, then the complete
	 *        string is copied.
	 * @param str is the string to be copied.
	 */
    String(size_t maxLen, const char *str); // just copy the first 'maxLen' characters into the string; copy all, if maxLen == -1
    //! Constructs a string that is a copy of \a str.
