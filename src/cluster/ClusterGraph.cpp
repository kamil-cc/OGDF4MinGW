...
ClusterGraph::ClusterGraph()
	: m_clusterIdCount(0), m_postOrderStart(0), m_rootCluster(0),
												 ...
												 List<cluster>& eL) const
{
	...
	if (!m_lcaSearch) 
	{
		m_lcaSearch = /*new*/OGDF_NEW ClusterArray<int>(*this, -1);
		m_vAncestor = /*new*/OGDF_NEW ClusterArray<cluster>(*this, 0);
		m_wAncestor = /*new*/OGDF_NEW ClusterArray<cluster>(*this, 0);
	}
						   ...
						   ClusterArray<cluster>* clusterCopy)
{
	...
	if (C.m_lcaSearch)
	{
		...
		m_lcaSearch = /*new*/OGDF_NEW ClusterArray<int>(*this, -1);//(*C.m_lcaSearch);

		m_vAncestor = /*new*/OGDF_NEW ClusterArray<cluster>(*this, 0); //*C.m_vAncestor);
		//m_vAncestor->init(*this, 0),
		m_wAncestor = /*new*/OGDF_NEW ClusterArray<cluster>(*this, 0);//*C.m_wAncestor);
...
//---------------------------------------------------------
//TODO: this part was copied from createcluster, where root could never
//be empty, check here if additional constraints properly inserted
