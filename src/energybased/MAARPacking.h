 ...
 * last checkin:
 *   $Author: klein $ 
 *   $Date: 2007-10-30 12:06:26 +0100 (Di, 30 Okt 2007) $ 
 ***************************************************************/
...
#ifndef MAARPACKING_H
#define MAARPACKING_H
...
class MAARPacking
{
   ...
   private:         
      ...
      //the drawing.
      ListIterator<PackingRowInfo>  find_Best_Fit_insert_position(ListIterator
						 <Rectangle> rect_item,List
						 <Rectangle>& R,int allow_tipping_over,
						 List<PackingRowInfo>& P,double 
						 aspect_ratio,double& aspect_ratio_area
      ...
      void  export_new_rectangle_positions(List<PackingRowInfo>& P,List<ListIterator
					   ...
					   <Rectangle> >& rectangle_order,List
					   <Rectangle>& R);
      ...
      Rectangle tipp_over(List<Rectangle>& R,ListIterator<Rectangle> rect_item);
