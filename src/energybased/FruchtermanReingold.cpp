 ...
 * last checkin:
 *   $Author: klein $ 
 *   $Date: 2007-11-15 14:27:51 +0100 (Do, 15 Nov 2007) $ 
 ***************************************************************/
...
void FruchtermanReingold :: make_initialisations (const Graph &G,NodeArray
			    <NodeAttributes>& A,NodeArray<DPoint>& F_rep, double bl,
			    DPoint d_l_c,int grid_quot)
{ 
