                  ...
                  <NodeAttributes>& A ,NodeArray<DPoint>& F_rep)
{
 ...
 calculate_neighbourcell_forces(G,A,quad_tree_leaves,F_direct);
...
void NMM :: make_initialisations (const Graph &G,NodeArray<NodeAttributes>& A,
				  NodeArray<DPoint>& F_rep, double bl,
...
{ 
 if(G.numberOfNodes() >= MIN_NODE_NUMBER) //using_NMM
  ...
  {  
    ...
    ExactMethod.make_initialisations(G,A,F_rep,bl,d_l_c,0);
  }
}
  ...
  if( (act_particle_number > particles_in_leaves()) &&
   ...
   {//if0
     ...
     //recursive calls for the half of the quad that contains the most particles
      ...
      split_in_x_direction(act_ptr,act_x_List_copy,act_y_List_copy,L_x_l_ptr,L_y_l_ptr,
                           L_x_r_ptr,L_y_r_ptr);
      if((L_x_r_ptr == NULL) || 
	 (L_x_l_ptr != NULL && L_x_l_ptr->size() > L_x_r_ptr->size()))
       {//if1 left half contains more particles
         split_in_y_direction(act_ptr,act_x_List_copy,act_y_List_copy,L_x_lb_ptr,
	  ...
	  split_in_y_direction(act_ptr,act_x_List_copy,act_y_List_copy,L_x_rb_ptr,
...
void NMM ::  split_in_x_direction(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
	     List<ParticleInfo>& L_y_copy,List <ParticleInfo>*& L_x_left_ptr,List
             <ParticleInfo>*& L_y_left_ptr,List <ParticleInfo>*& L_x_right_ptr,List
             <ParticleInfo>*& L_y_right_ptr)
{
 ...
 if(left_particleList_empty)
 ...
 else if(right_particleList_empty)
  {
    ...
    x_delete_right_subLists(act_ptr,L_x_copy,L_y_copy,L_x_left_ptr,L_y_left_ptr,
			  L_x_right_ptr,L_y_right_ptr,last_left_item);
 else //left particleList is smaller or equal to right particleList
    x_delete_left_subLists(act_ptr,L_x_copy,L_y_copy,L_x_left_ptr,L_y_left_ptr,
			  L_x_right_ptr,L_y_right_ptr,last_left_item);
}


void NMM ::  split_in_y_direction(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
	     List<ParticleInfo>& L_y_copy,List <ParticleInfo>*& L_x_left_ptr,List
             <ParticleInfo>*& L_y_left_ptr,List <ParticleInfo>*& L_x_right_ptr,List
             <ParticleInfo>*& L_y_right_ptr)
{
 ...
 if(left_particleList_empty)
  ...
  y_delete_right_subLists(act_ptr,L_x_copy,L_y_copy,L_x_left_ptr,L_y_left_ptr,
			  L_x_right_ptr,L_y_right_ptr,last_left_item);
 else //left particleList is smaller or equal to right particleList
  y_delete_left_subLists(act_ptr,L_x_copy,L_y_copy,L_x_left_ptr,L_y_left_ptr,
			  L_x_right_ptr,L_y_right_ptr,last_left_item);
}


void NMM:: x_delete_right_subLists(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
	     List<ParticleInfo>& L_y_copy,List <ParticleInfo>*& L_x_left_ptr,List
             <ParticleInfo>*& L_y_left_ptr,List <ParticleInfo>*& L_x_right_ptr,List
             <ParticleInfo>*& L_y_right_ptr,ListIterator<ParticleInfo> last_left_item)
{
...
void NMM:: x_delete_left_subLists(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
	     List<ParticleInfo>& L_y_copy,List <ParticleInfo>*& L_x_left_ptr,List
             <ParticleInfo>*& L_y_left_ptr,List <ParticleInfo>*& L_x_right_ptr,List
             <ParticleInfo>*& L_y_right_ptr,ListIterator<ParticleInfo> last_left_item)
{
...
void NMM:: y_delete_right_subLists(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
	     List<ParticleInfo>& L_y_copy,List <ParticleInfo>*& L_x_left_ptr,List
             <ParticleInfo>*& L_y_left_ptr,List <ParticleInfo>*& L_x_right_ptr,List
             <ParticleInfo>*& L_y_right_ptr,ListIterator<ParticleInfo> last_left_item)
{
...
void NMM:: y_delete_left_subLists(QuadTreeNodeNM* act_ptr,List<ParticleInfo>& L_x_copy,
	     List<ParticleInfo>& L_y_copy,List <ParticleInfo>*& L_x_left_ptr,List
             <ParticleInfo>*& L_y_left_ptr,List <ParticleInfo>*& L_x_right_ptr,List
             <ParticleInfo>*& L_y_right_ptr,ListIterator<ParticleInfo> last_left_item)
{
...
void NMM ::  split_in_y_direction(QuadTreeNodeNM* act_ptr,List<ParticleInfo>*& L_x_ptr,
	     List <ParticleInfo>*& L_x_b_ptr,List<ParticleInfo>*& L_x_t_ptr,List
	     <ParticleInfo>*& L_y_ptr,List <ParticleInfo>*& L_y_b_ptr,
 ...
 if(subtree_min_boxlength >=  MIN_BOX_LENGTH)
  {
	...
	set_contained_nodes_for_leaves(A,T,subtree_root_ptr,leaf_ptr,maxindex);
	T.set_act_ptr(subtree_root_ptr);
...
void NMM :: set_contained_nodes_for_leaves(NodeArray<NodeAttributes>&A,QuadTreeNM& T,
...
{  
 ...
 int max_power_of_2_index = 30;//up to this level standard integer arithmetic is used
 DPoint nullpoint (0,0);
 IPoint Sm_position;
...
void NMM :: set_center(NodeArray<NodeAttributes>& A, QuadTreeNodeNM* act_ptr)
{
...
void NMM :: calculate_neighbourcell_forces(const Graph& G, NodeArray<NodeAttributes>& 
