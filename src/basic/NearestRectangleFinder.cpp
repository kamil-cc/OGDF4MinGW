...
// of a rectangle
//---------------------------------------------------------
struct NearestRectangleFinder::PairCoordId
{
...
{
public:
	bool less (const PairCoordId &x, const PairCoordId &y) {
		return x.m_coord > y.m_coord;
	}
	bool leq  (const PairCoordId &x, const PairCoordId &y) {
		return x.m_coord >= y.m_coord;
	}
	bool equal(const PairCoordId &x, const PairCoordId &y) {
		return x.m_coord == y.m_coord;
	}
};
	...
	Array<List<PairRectDist> > &nearest)
{
	...
	listTop   .quicksortCT(comparer);
	listBottom.quicksortCT(comparer);
	...
	sortedPoints.quicksortCT(yCoordComparer);
